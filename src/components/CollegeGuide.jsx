...
const CollegeGuide = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {[
                { number: '20+ Cities', label: 'State-wide coverage' },
                { number: '100%', label: 'Guidance' },
                { number: '10+', label: 'Top-Ranked Colleges' }
              ].map((stat, index) => (
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {/* Featured Colleges Scrollable Section */}
    <div className="overflow-x-auto">
      <div className="flex gap-8 min-w-max">
        {featuredColleges.map((college, index) => (
          <div key={index} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden group w-80">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {/* <button className="bg-white text-blue-600 px-8 py-4 rounded-md font-medium hover:bg-gray-50 transition-colors inline-flex items-center gap-2 group">
            Now
            Get Started <ArrowRight className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
          </button> */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
              ...
              <span className="text-blue-600 text-2xl font-bold">NSquire</span>
            </Link>
